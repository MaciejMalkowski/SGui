...
"}"));
        ...
        PO1_speed = new QLabel(widget_11);
        PO1_speed->setObjectName("PO1_speed");

        verticalLayout_13->addWidget(PO1_speed);
...
"}"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        PO1_speed->setText(QCoreApplication::translate("MainWindow", "Pr\304\231dko\305\233\304\207", nullptr));
